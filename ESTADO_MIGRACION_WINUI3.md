...
> **mergeada en `main`** y publicada (repositorio público, release actual **`v0.82.0`** con instalable portable).
...
> dominio de las pantallas está **implementada y verificada** (build 0 err · smoke 109/109 · 125/125
